...
import customheaderandfooter.RecyclerViewWithDamping;
...
/**
 * Created by 员工 on 2016/11/1.
 */
public class MdActivity extends AppCompatActivity implements ConvertHeader {
    ...
    CustomCoordinatorLayout mCustomCoordinatorLayout;
...
//        initMd();
    ...
    private void initMd() {
        mCustomCoordinatorLayout = (CustomCoordinatorLayout) findViewById(R.id.mcod_layout);
